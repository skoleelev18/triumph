...
window.I18n = (function () {
  ...
  const TRANSLATIONS = {
    nb: {
      ...
      ocrWorking: "Analyserer bildet...",
      ocrProgress: "Leser tekst... {percent}%",
      ocrEmpty: "Fant ingen lesbar tekst i bildet. Prøv et tydeligere bilde.",
      ocrError: "Noe gikk galt under tekstgjenkjenningen. Prøv igjen.",
    ...
    en: {
      ...
      ocrWorking: "Analysing the image...",
      ocrProgress: "Reading text... {percent}%",
      ocrEmpty: "No readable text found in the image. Try a clearer photo.",
      ocrError: "Something went wrong during text recognition. Please try again.",
