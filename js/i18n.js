...
window.I18n = (function () {
  ...
  const TRANSLATIONS = {
    nb: {
      ...
      brokeText: "Du er blakk! Svar riktig på et spørsmål for å få litt startkapital.",
      bailoutBtn: "Få startkapital",
      ...
      questionsWaiting: " Nå venter {count} spørsmål — riktig svar gir {reward} chips hver.",
      questionProgress: "Spørsmål {index} av {count}",
      bonusQuestion: "Bonusspørsmål",
      answerCorrectChips: "✅ Riktig! +{reward} chips",
      answerWrongTryAgain: "❌ Feil! Prøv igjen om litt.",
      roundDone: "Runde ferdig: {correct}/{count} riktige, +{chips} chips.",
    ...
    en: {
      ...
      brokeText: "You're broke! Answer a question correctly to get some starting capital.",
      bailoutBtn: "Get starting capital",
      ...
      questionsWaiting: " Up next: {count} question(s) — each correct answer is worth {reward} chips.",
      ...
      roundDone: "Round done: {correct}/{count} correct, +{chips} chips.",
